...
namespace zFREP
{
    public class Difference: GH_Component
    {
        ...
        /// </summary>
        public Difference()
          : base("Field Difference", "Field Difference",
              "Perform the boolean difference of two fields.",
              "zFREP", "Booleans")
        {
        }
        ...
        {
            pManager.AddGenericParameter("Field Result", "Field", "Difference Field", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.SetData(0, Field3d.CreateDifference(f1, f0));
        }

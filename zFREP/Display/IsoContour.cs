...
namespace zFREP
{
    public class IsoContour: GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IsoContourComponent class.
        /// </summary>
        public IsoContour()
          : base("Iso Contour", "IsoContour",
              "Compute Iso Contour",
              "zFREP", "Display")
        {
        }
        ...
        {
            pManager.AddCurveParameter("Iso Contour", "Iso Contour", "Field Iso Contour", GH_ParamAccess.list);
        }
